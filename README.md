...
Funktionen:
- **Authentifizierung**: Benutzer können sich registrieren und einloggen, wobei die Session sicher verwaltet wird.$
- **CRUD-Operationen**: Eingeloggte Nutzer können beiträge erstellen, bearbeiten und löschen. Auf der Startseite werden alle Beiträge in einem Feed angezeigt.
- **Interaktionen**: Es wurde ein Like und Dislike System implementiert. Beiträge, die man mit "Gefällt mir" makiert werden in den Einstellungen aufgelistet und schnell wieder darauf zu zugreifen.
